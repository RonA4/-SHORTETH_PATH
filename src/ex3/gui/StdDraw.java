...
/******************************************************************************
 *  Compilation:  javac ex3.driver.StdDraw.java
 *  Execution:    java ex3.driver.StdDraw
 *  Dependencies: none
 *
 *
...
/**
 * The {@code ex3.driver.StdDraw} class provides a basic capability for
 * creating drawings with your programs. It uses a simple graphics model that
 ...
 * <p>
 * <b>Getting started.</b>
 * To use this class, you must have {@code ex3.driver.StdDraw.class} in your
 * Java classpath. If you used our autoinstaller, you should be all set.
 * Otherwise, either download
 * <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 * and add to your Java classpath or download
 * <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">ex3.driver.StdDraw.java</a>
 ...
 *           ex3.driver.StdDraw.setPenRadius(0.05);
 *           ex3.driver.StdDraw.setPenColor(ex3.driver.StdDraw.BLUE);
 *           ex3.driver.StdDraw.point(0.5, 0.5);
 *           ex3.driver.StdDraw.setPenColor(ex3.driver.StdDraw.MAGENTA);
 *           ex3.driver.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 * The methods {@code ex3.driver.StdDraw.line()} and {@code ex3.driver.StdDraw.point()}
 * draw lines and points; the methods {@code ex3.driver.StdDraw.setPenRadius()}
 * and {@code ex3.driver.StdDraw.setPenColor()} control the line thickness and color.
 * <p>
 ...
 * and represented in degrees. For example, {@code ex3.driver.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  ex3.driver.StdDraw.filledPolygon(x, y);
 * </pre>
 * p>
 * <b>Pen size.</b>
 ...
 * </ul>
 * p>
 * For example, {@code ex3.driver.StdDraw.setPenRadius(0.025)} makes
 ...
 * For example, {@code ex3.driver.StdDraw.setPenColor(ex3.driver.StdDraw.MAGENTA)} sets the
 ...
 * For example, {@code ex3.driver.StdDraw.setCanvasSize(800, 800)}
 ...
 * leave a small margin, you can call {@code ex3.driver.StdDraw.setScale(-.05, 1.05)}.
 * p>
 ...
 *  ex3.driver.StdDraw.setFont(font);
 *  ex3.driver.StdDraw.text(0.5, 0.5, "Hello, World");
 * </pre>
 * p>
 * <b>Images.</b>
 ...
 * {@code ex3.driver.StdDraw.clear(ex3.driver.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 * of gray.
 * p>
 ...
 * <pre>
 *  ex3.driver.StdDraw.setScale(-2, +2);
 *  ex3.driver.StdDraw.enableDoubleBuffering();
 *
 *  for (double t = 0.0; true; t += 0.02) {
 *      double x = Math.sin(t);
 *      double y = Math.cos(t);
 *      ex3.driver.StdDraw.clear();
 *      ex3.driver.StdDraw.filledCircle(x, y, 0.05);
 *      ex3.driver.StdDraw.filledCircle(-x, -y, 0.05);
 *      ex3.driver.StdDraw.show();
 *      ex3.driver.StdDraw.pause(20);
 *  }
 * </pre>
 * p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public final static List<BoardSize> OPTIONS_SIZE = List.of(new BoardSize(5),new BoardSize(20), new BoardSize(40), new BoardSize(60));
    /**
     * The color black.
     */
    ...
    private static JMenuBar createMenuBar() {
        ...
        menuBar.add(menuMap);
        createJMenuItem(menuMap,"5x5");
        createJMenuItem(menuMap, "20x20");
        createJMenuItem(menuMap, "40x40");
        createJMenuItem(menuMap, "60x60");
        JMenu colorMenu = new JMenu("Color");
        menuBar.add(colorMenu);
        createJMenuItem(colorMenu, "Green");
        createJMenuItem(colorMenu, "Black");
        createJMenuItem(colorMenu, "Blue");
        createJMenuItem(colorMenu, "Red");
        createJMenuItem(colorMenu, "Yellow");
        createJMenuItem(colorMenu, "Pink");
        JMenu drawMenu = new JMenu("Draw");
        createJMenuItem(drawMenu, "Rect");
        menuBar.add(drawMenu);
        JMenu algoMenu = new JMenu("Algo");
        createJMenuItem(algoMenu, "shortest path");
        menuBar.add(algoMenu);
        return menuBar;
    }

    private static void createJMenuItem(JMenu menu, String name) {
     ...
     * {@code ex3.driver.StdDraw.BLACK}, {@code ex3.driver.StdDraw.BLUE}, {@code ex3.driver.StdDraw.CYAN},
     * {@code ex3.driver.StdDraw.DARK_GRAY}, {@code ex3.driver.StdDraw.GRAY}, {@code ex3.driver.StdDraw.GREEN},
     * {@code ex3.driver.StdDraw.LIGHT_GRAY}, {@code ex3.driver.StdDraw.MAGENTA}, {@code ex3.driver.StdDraw.ORANGE},
     * {@code ex3.driver.StdDraw.PINK}, {@code ex3.driver.StdDraw.RED}, {@code ex3.driver.StdDraw.WHITE}, and
     * {@code ex3.driver.StdDraw.YELLOW}.
     *
     ...
     * @throws IllegalArgumentException if {@code radius} is negative
     */
    public static Shape filledCircle(double x, double y, double radius) {
        if (!(radius >= 0)) throw new IllegalArgumentException("radius must be nonnegative");
        Shape shape = null;
        double xs = scaleX(x);
        double ys = scaleY(y);
        ...
        if (ws <= 1 && hs <= 1) {
            ...
            shape = new Ellipse2D.Double(xs - ws / 2, ys - hs / 2, ws, hs);
            offscreen.fill(shape);
        }
        draw();
        return shape;
    }
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to ex3.driver.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
    ...
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to ex3.driver.StdDraw)
        try {
            URL url = ex3.driver.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
    ...
    public static void setMenuItemListener(MenuItemListener listener) {
        mMenuItemListener = listener;
    }

    private static MenuItemListener mMenuItemListener;
    private static MouseClickedListener mMouseClickListener;

    public static void setMouseClickListener(MouseClickedListener listener) {
        mMouseClickListener = listener;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (mMenuItemListener != null) {
            mMenuItemListener.onMenuItemClicked(e);
        }
...
//        }
    ...
    public void mouseClicked(MouseEvent e) {
        if (mMouseClickListener != null) {
            mMouseClickListener.onScreenMouseClicked(e);
        }
    }
